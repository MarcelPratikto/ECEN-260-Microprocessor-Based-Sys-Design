 ...
 * PARAMETER 1: lowest number you want generated
 * PARAMETER 2: highest number you want generated
 ...
 * Animate actors.
 * PARAMETER 1: pointer to player
 * PARAMETER 2: array of addresses of actors
 * PARAMETER 3: number of actors
 */
